from weather_model import WeatherReport
from geopy.geocoders import Nominatim
from datetime import datetime, timedelta
import requests, os

# Register for a Dark Sky API key https://darksky.net/dev
DARK_SKY_API_KEY = 'a3a2383d5c1be509a333a1131cceb906'
    ...
    def getWeatherReports(self, data, location):
        ...
        for i in range(delta.days + 1):
            ...
            response = requests.get(
                "https://api.darksky.net/forecast/" + DARK_SKY_API_KEY + "/" + latitude + "," + longitude + "," + search_date + "?" + option_list)
